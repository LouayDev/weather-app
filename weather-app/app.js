...
const moreinfo = document.querySelector('.other-into-btn');
const section = document.querySelector('.other-info-section');
let state = true;
...
moreinfo.addEventListener('click', () => {
  switch (state) {
    ...
    case false:
      moreinfo.style.bottom = '-60px';
      section.style.bottom = '-390px';
      state = true;
      console.log(state);
  }
});
